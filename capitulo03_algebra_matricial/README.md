...
Operaciones matriciales, descomposiciones y proyecciones
...
- `cap3_interactivo.ipynb` - Jupyter Notebook completo
- `cap3_analisis.Rmd` - R Markdown con análisis
...
- [Capítulo anterior](../capitulo02_xxx/)
- [Capítulo siguiente](../capitulo04_xxx/)
- [Datos comunes](../datos_comunes/)

## 📧 Reportar Problemas

Si encuentras errores, abre un [Issue](https://github.com/tu-usuario/econometria-libro-codigo/issues) con la etiqueta `capitulo-3`.
